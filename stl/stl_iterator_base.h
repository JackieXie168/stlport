...
INLINE_LOOP void __distance(_BidirectionalIterator __first, 
...
INLINE_LOOP void __advance(_InputIter& __i, _Distance __n, input_iterator_tag) {
  while (__n--) ++__i;
}

# if defined (__STL_NONTEMPL_BASE_MATCH_BUG)
template <class _ForwardIterator, class _Distance>
INLINE_LOOP void __advance(_ForwardIterator& i, _Distance n, forward_iterator_tag) {
    while (n--) ++i;
}
# endif
...
template <class _BidirectionalIterator, class _Distance>
INLINE_LOOP void __advance(_BidirectionalIterator& __i, _Distance __n, 
