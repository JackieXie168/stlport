...
// Uncomment if long double is available
...
// Uncomment this if your compiler defines "bool" in <yvals.h>
...
// Compiler supports explicit template arguments for functions
...
//  __STL_MULTI_CONST_TEMPLATE_ARG_BUG
...
// Uncomment if using new-style iostreams
// #define    __STL_USE_NEW_IOSTREAMS	1

// Define this if compiler lacks <exception> header
// #  define __STL_NO_EXCEPTION_HEADER 1

// Compiler provides string header
// #  define __STL_HAS_STRING_HEADER

// Compiler provides stdexcept header
// #  define __STL_HAS_STDEXCEPT_HEADER

// Uncomment this if your C library has lrand48() function
// #  define __STL_RAND48 1

// uncomment to use new-style headers like <new>, <cstddef>, etc.
