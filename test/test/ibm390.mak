...
SUFFIXES: .cpp.o.exe.out.res.C

%.o : %.cpp
	_CXX_CXXSUFFIX=cpp $(CXX) $(CXXFLAGS) $< -c -o $@

%.o : %.C
	_CXX_CXXSUFFIX=C $(CXX) $(CXXFLAGS) $< -c -o $@
...
istmit1.out: istmit1.cpp
	_CXX_CXXSUFFIX=cpp $(CXX) $(CXXFLAGS) $< $(STAT_MODULE) $(LIBSTDCXX) -lstdc++ $(LIBS) -o istmit1
