...
typedef EH_STD::string TestString;
...
void test_string()
{
    ...
    {
        TestString::value_type x( random_number(random_base) );	// initialize before use
    ...
    WeakCheck( testString, test_insert_one<TestString>(testString, testString.size()) );
    ...
    WeakCheck( testString, test_insert_n<TestString>(testString, random_number(random_base), testString.size() ) );
