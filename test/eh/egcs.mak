...
CXXFLAGS = -Wall -g  -D__STL_USE_NEWALLOC -DNO_FAST_ALLOCATOR -ansi -I${STL_INCL}  -I. ${REPO_FLAGS} ${CXX_EXTRA_FLAGS} -DEH_VECTOR_OPERATOR_NEW -D__STL_DEBUG -D__STL_NO_DEBUG_EXCEPTIONS

# CXXFLAGS = -Wall -I${STL_INCL}  -I. -D__STL_USE_NEWALLOC ${REPO_FLAGS} ${CXX_EXTRA_FLAGS}
